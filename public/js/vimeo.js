...
var Vimeo = __webpack_require__(239);

var vimeoPost = function vimeoPost(type, event, player) {
...
window.addEventListener("load", function () {
    ...
    var trigger = document.getElementById('demo__trigger');

    var iframe = document.getElementById('vimeo-wrapper__player');

    if (iframe === null) return;

    var wrapper = document.getElementById('vimeo-wrapper');

    var brandCenter = document.getElementById('brand-center');
    ...
    player.on('play', function (event) {
        return vimeoPost('play', event, player);
    });

    player.on('pause', function (event) {
        return vimeoPost('pause', event, player);
    });

    player.on('ended', function (event) {
        return vimeoPost('ended', event, player);
    });
    ...
    trigger.addEventListener("click", function () {
        ...
        if (trigger.classList.contains('demo--play')) {
            ...
            player.play().then().catch(function (e) {
...
/* WEBPACK VAR INJECTION */(function(global, setImmediate) {/*! @vimeo/player v2.6.4 | (c) 2018 Vimeo | MIT License | https://github.com/vimeo/player.js */
