typeof navigator === "object" && (function (global, factory) {
	    ...
	    extend: function extend() {
	        ...
	        Object.defineProperty(player.media, 'quality', {
	            ...
	            set: function set(input) {
	                ...
	                player.debug.warn('*********** html5.js -> : setQuality', input);
	...
	var controls = {
	    ...
	    createButton: function createButton(buttonType, attr) {
	        ...
	        switch (buttonType) {
	            ...
	            case 'download':
	                toggle = true;
	                label = 'download';
	                labelPressed = 'download';
	                icon = 'download';
	                iconPressed = 'download-pressed';
	                break;

	            case 'theater':
	                toggle = true;
	                label = 'theater';
	                labelPressed = 'exitTheater';
	                icon = 'theater';
	                iconPressed = 'theater-pressed';
	                break;

	            case 'in':
	                toggle = true;
	                label = 'in';
	                labelPressed = 'removeIn';
	                icon = 'in';
	                iconPressed = 'in-pressed';
	                break;

	            case 'out':
	                toggle = true;
	                label = 'out';
	                labelPressed = 'removeOut';
	                icon = 'out';
	                iconPressed = 'out-pressed';
	                break;
	            /********/
	    ...
	    //******************************************************************************* CUSTOM
	    // Create time display
	    createQuality: function createQuality(type) {
	    ...
	    updateQuality: function updateQuality(quality) {
	        ...
	        this.debug.warn('controls.js -> update quality from controls 583', quality);

	        var target = this.elements.display.quality;

	        this.debug.log('controls.js -> target', target);

	        if (quality === 'auto') {

	            //const index = hls.loadLevel;
	            var index = hls.nextLoadLevel;

	            console.error('controls.js -> updqte quality hls.loadlevel :', index);
	            console.error('controls.js ->  typeof update quality hls.loadlevel :', typeof index === 'undefined' ? 'undefined' : _typeof(index));
	            console.warn('hls currentLevel :', hls.currentLevel);
	            console.warn('hls nextLevel :', hls.nextLevel);
	            console.warn('hls nextLoadLevel :', hls.nextLoadLevel);
	            console.warn('hls firstLevel :', hls.firstLevel);
	            //console.error(typeof index)
	            console.error('this.config.quality.options:', this.config.quality.options);

	            var q = this.config.quality.options[index] + 'p';
	    ...
	    setQualityMenu: function setQualityMenu(options) {
	        ...
	        /***********************************FORCE OPTIONS QUALITY  TO BE FROM CONFIG::*/
	    ...
	    create: function create(data) {
	        ...
	        if (is$1.empty(this.config.controls)) {
	            this.debug.error('control.js -> return');
	            return null;
	        }
	        ...
	        // ******************************************************************************************************************CUSTOM
	        if (this.config.controls.includes('in')) {
	            container.appendChild(controls.createButton.call(this, 'in'));
	        }

	        // ******************************************************************************************************************CUSTOM
	        if (this.config.controls.includes('out')) {
	            container.appendChild(controls.createButton.call(this, 'out'));
	        }
	        //**************************************************************************************************************************
	        ...
	        //**************************************************************************************************************** CUSTOM
	        if (this.config.controls.includes('quality-info')) {
	            container.appendChild(controls.createQuality.call(this, 'quality'));
	        }
	        //*****************************************************************************************************************/
	        ...
	        if (this.config.controls.includes('download')) {
	            container.appendChild(controls.createButton.call(this, 'download'));
	        }
	        //******************************************************************************************************************/

	        // ***************************************************************************************************************** THEATER
	        if (this.config.controls.includes('theater')) {
	            container.appendChild(controls.createButton.call(this, 'theater'));
	        }
	        //******************************************************************************************************************/
	...
	var defaults$1 = {
	    ...
	    i18n: {
	        ...
	        exitTheater: 'Normal Mode',
	        in: 'Edit IN',
	        removeIn: 'Remove IN point',
	        out: 'Edit OUT',
	        removeOut: 'Remove OUT point',
	        /**********************************/
	    ...
	    createClass(Listeners, [{
	        ...
	        value: function media() {
	            ...
	            on.call(this.player, this.player.media, 'qualitychange', function (event) {
	                // Update UI
	                _this3.player.debug.warn('listeners.js -> on qualitychange update ui (event.detail.quality)', event.detail.quality);

	                _this3.player.debug.error('listeners.js -> controls.updateQuality');

	                //*****************************************************************
	                controls.updateQuality.call(_this3.player, event.detail.quality);
	                //********************************************************************

	                _this3.player.debug.error('listeners.js -> controls.updateSetting');
	        ...
	        value: function controls$$1() {
	            ...
	            //********************************************************************************************************************
	            // DOWNLOAD
	            bind(this.player.elements.buttons.download, 'click', function () {
	                _this4.player.debug.error('listeners.js -> CLICK DOWNLOAD !!!!!!!!!!!!');
	                _this4.player.elements.buttons.download.pressed = !_this4.player.elements.buttons.download.pressed;
	            }, 'download');
	            //********************************************************************************************************************

	            //********************************************************************************************************************
	            // THEATER
	            bind(this.player.elements.buttons.theater, 'click', function () {
	                _this4.player.debug.error('listeners.js -> CLICK THEATER !!!!!!!!!!!!');
	                _this4.player.elements.buttons.theater.pressed = !_this4.player.elements.buttons.theater.pressed;
	                //isTheater = !isTheater;
	                //var el = document.getElementById('is-theater').getElementsByTagName('input')[0];
	                //el.checked = isTheater;
	                Theater.toggle();
	            }, 'theater');
	            //********************************************************************************************************************
	            ...
	            //********************************************************************************************************************
	            // EDIT
	            bind(this.player.elements.buttons.in, 'click', function () {

	                _this4.player.elements.buttons.in.pressed = !_this4.player.elements.buttons.in.pressed;
	                Edit.set('in', _this4.player.elements.buttons.in.pressed);
	            }, 'in');

	            bind(this.player.elements.buttons.out, 'click', function () {

	                //player.muted = !player.muted

	                _this4.player.elements.buttons.out.pressed = !_this4.player.elements.buttons.out.pressed;
	                Edit.set('out', _this4.player.elements.buttons.out.pressed);
	            }, 'out');
	            //********************************************************************************************************************
	...
	var Plyr = function () {
	    ...
	    createClass(Plyr, [{
	        ...
	        set: function set(input) {
	            ...
	            this.debug.error('plyr.js -> QUALITY SET plyr.js');
	            this.debug.error('plyr.js -> config', config);
	            this.debug.error('plyr.js -> this.options.quality', options);
	            this.debug.error('plyr.js -> this.options', this.options);
	            this.debug.error('plyr.js -> input', input);
	            ...
	            */
	            ...
	            if (typeof input === 'string' || typeof input === 'number') {
	                ...
	                if (input !== 'auto') quality = parseInt(quality);
	            }

	            console.warn('plyr.js -> config.default', config.default);
	            console.warn('plyr.js -> input ', input);
	            console.warn('plyr.js -> quality ', quality);
	            console.error('plyr.js -> typeof quality ', typeof quality === 'undefined' ? 'undefined' : _typeof(quality));
	            console.warn('****************');

	            this.debug.warn('plyr.js -> quality in plyr.js ::::::', quality);
	            //**************************************************************************************************************** */
	            ...
	            */
	            ...
	            this.debug.warn('plyr.js -> set quality media', this.media);
	            this.debug.warn('plyr.js -> config selected : ', config);
	        }
